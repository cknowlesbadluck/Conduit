...
// Performance optimization: Freeze static context object so getDevelopmentContext()
// returns a single immutable reference without re-allocating objects and arrays on every call.
const DEVELOPMENT_CONTEXT: DevelopmentContext = Object.freeze({
